...
const Hero = () => {
  ...
  // Depth-receding transforms tied to scroll progress
  ...
  return (
    <section
      ref={heroRef}
      id="home"
      className="relative flex min-h-screen items-center justify-center bg-grid px-6 py-20"
    >
      {/* Radial gradient overlay for depth */}
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_20%,var(--color-bg)_70%)]" />
